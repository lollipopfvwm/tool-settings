...
let s:palette.operator  = {'dark': "#3cbbb1",  'light': "#E2C247"}
let s:palette.tag       = {'dark': "#36A3D9",  'light': "#36A3D9"}
let s:palette.regexp    = {'dark': "#95E6CB",  'light': "#1CBF59"}
let s:palette.string    = {'dark': "#f2cc8f",  'light': "#48B300"}
let s:palette.function  = {'dark': "#b388eb",  'light': "#F29111"}
let s:palette.special   = {'dark': "#99ffab",  'light': "#E9B111"}
let s:palette.keyword   = {'dark': "#9a99ff",  'light': "#FF7733"}

let s:palette.error     = {'dark': "#FF3333",  'light': "#FF3333"}
let s:palette.accent    = {'dark': "#F29718",  'light': "#FF6A00"}
let s:palette.panel     = {'dark': "#1c1d21",  'light': "#FFFFFF"}
let s:palette.guide     = {'dark': "#2D3640",  'light': "#708090"}
let s:palette.line      = {'dark': "#1c1d21",  'light': "#F3F3F3"}
let s:palette.selection = {'dark': "#1c1d21",  'light': "#F0EEE4"}
let s:palette.fg        = {'dark': "#adb5bd",  'light': "#5C6769"}
